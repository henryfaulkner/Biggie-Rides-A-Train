...
{
	private static readonly StringName _FALLING_ARROW_UP_SCENE = new StringName("res://Pages/CombatScenes/DjBattle/FallingArrows/FallingArrowUp.tscn");
	private static readonly StringName _FALLING_ARROW_RIGHT_SCENE = new StringName("res://Pages/CombatScenes/DjBattle/FallingArrows/FallingArrowRight.tscn");
	private static readonly StringName _FALLING_ARROW_DOWN_SCENE = new StringName("res://Pages/CombatScenes/DjBattle/FallingArrows/FallingArrowDown.tscn");
	private static readonly StringName _FALLING_ARROW_LEFT_SCENE = new StringName("res://Pages/CombatScenes/DjBattle/FallingArrows/FallingArrowLeft.tscn");
